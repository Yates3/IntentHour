...
- 90-second walkthrough: [DEMO_SCRIPT.md](DEMO_SCRIPT.md) — video pending
- Detailed case study: [PORTFOLIO_CASE_STUDY.md](PORTFOLIO_CASE_STUDY.md)
...
2. Read the [90-second demo script](DEMO_SCRIPT.md).
3. Review the Desktop screenshots and release status in the [README](../README.md).
