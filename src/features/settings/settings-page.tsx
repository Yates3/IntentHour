...
export function SettingsPage({ pro, refreshEntitlement, navigate }: { pro: boolean; refreshEntitlement: () => Promise<void>; navigate: (path: string) => void }) {
